...
def data():
    tenv = Environment(loader=FileSystemLoader("src/evazan_ai/resources/templates/"))
...
def answer_question(question, q_temp, cache):
    ...
    result = "".join(filter(lambda x: x is not None, evazan_ai.process_input(prompt)))
