...
from evazan_ai.presenters.whatsapp_presenter import WhatsAppPresenter
from evazan_ai.util.general_helpers import validate_cors
...
# Initialize the Evazan AI agent
...
async def main_webhook(request: Request, cors_ok: bool = Depends(validate_cors)) -> None:
    ...
    # Actual code to process the incoming message using Evazan AI agent then reply to the sender
