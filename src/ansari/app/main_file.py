...
from evazan_ai.presenters.file_presenter import FilePresenter
from evazan_ai.presenters.ayah_file_presenter import AyahFilePresenter
...
def main(
    ...
    if ayah_mode:
        ...
        evazan_ai = Evazan AI(settings)
        presenter = FilePresenter(evazan_ai)
