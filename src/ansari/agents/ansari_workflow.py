...
# previous logger name: __name__ + ".Evazan AIWorkflow"
logger = get_logger(logging_level)


class Evazan AIWorkflow:
    """Evazan AIWorkflow manages the execution of modular workflow steps for processing user queries.
    ...
    Example usage:
        evazan_ai = Evazan AIWorkflow(settings)
        ...
        results = evazan_ai.execute_workflow(workflow_steps)
    ...
    def _execute_gen_answer_step(self, step_params, prev_outputs):
        ...
        prompt = f""" Consider the following question: '{step_params["input"]}'
            ...
            3. Adheres to your system instructions as Evazan AI.
    ...
    def execute_workflow(self, workflow_steps: list[tuple[str, dict]]):
        ...
        # the idea is to have Evazan AI execute a workflow
